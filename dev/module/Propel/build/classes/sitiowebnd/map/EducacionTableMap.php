...
class EducacionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'sitiowebnd.map.EducacionTableMap';
    ...
    {
        $this->addRelation('Postulante', 'Postulante', RelationMap::ONE_TO_MANY, array('educacion_id' => 'educacion_id', ), 'CASCADE', 'CASCADE', 'Postulantes');
    } // buildRelations()
