...
class SepomexTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'sitiowebnd.map.SepomexTableMap';
    ...
    {
        $this->addRelation('Sucursal', 'Sucursal', RelationMap::ONE_TO_MANY, array('sepomex_id' => 'sepomex_id', ), 'CASCADE', 'CASCADE', 'Sucursals');
    } // buildRelations()
