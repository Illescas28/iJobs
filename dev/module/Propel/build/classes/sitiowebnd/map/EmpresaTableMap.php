...
class EmpresaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'sitiowebnd.map.EmpresaTableMap';
    ...
    {
        $this->addRelation('Sucursal', 'Sucursal', RelationMap::ONE_TO_MANY, array('empresa_id' => 'empresa_id', ), 'CASCADE', 'CASCADE', 'Sucursals');
    } // buildRelations()
