...
abstract class BaseUsuarioPeer
{
    ...
    const USUARIO_CONTRASENA = 'usuario.usuario_contrasena';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UsuarioId', 'UsuarioNombre', 'UsuarioContrasena', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('usuarioId', 'usuarioNombre', 'usuarioContrasena', ),
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::USUARIO_ID, UsuarioPeer::USUARIO_NOMBRE, UsuarioPeer::USUARIO_CONTRASENA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USUARIO_ID', 'USUARIO_NOMBRE', 'USUARIO_CONTRASENA', ),
        BasePeer::TYPE_FIELDNAME => array ('usuario_id', 'usuario_nombre', 'usuario_contrasena', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UsuarioId' => 0, 'UsuarioNombre' => 1, 'UsuarioContrasena' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('usuarioId' => 0, 'usuarioNombre' => 1, 'usuarioContrasena' => 2, ),
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::USUARIO_ID => 0, UsuarioPeer::USUARIO_NOMBRE => 1, UsuarioPeer::USUARIO_CONTRASENA => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USUARIO_ID' => 0, 'USUARIO_NOMBRE' => 1, 'USUARIO_CONTRASENA' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('usuario_id' => 0, 'usuario_nombre' => 1, 'usuario_contrasena' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioPeer::USUARIO_CONTRASENA);
        } else {
