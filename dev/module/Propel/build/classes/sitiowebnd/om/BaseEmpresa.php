...
abstract class BaseEmpresa extends BaseObject implements Persistent
{
    ...
    public function setEmpresaId($v)
    {
        ...
        if ($this->empresa_id !== $v) {
            $this->empresa_id = $v;
            $this->modifiedColumns[] = EmpresaPeer::EMPRESA_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EmpresaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EmpresaPeer::EMPRESA_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmpresaPeer::EMPRESA_ID)) $criteria->add(EmpresaPeer::EMPRESA_ID, $this->empresa_id);
    ...
    {
        $criteria = new Criteria(EmpresaPeer::DATABASE_NAME);
        $criteria->add(EmpresaPeer::EMPRESA_ID, $this->empresa_id);
     ...
     * @return PropelObjectCollection|Sucursal[] List of Sucursal objects
     */
    public function getSucursalsJoinSepomex($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SucursalQuery::create(null, $criteria);
