...
abstract class BaseCorreo extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the correo_nombre field.
     * @var        string
     */
    protected $correo_nombre;
    ...
    /**
     * Get the [correo_nombre] column value.
     *
     * @return string
     */
    ...
    public function setCorreoId($v)
    {
        ...
        if ($this->correo_id !== $v) {
            $this->correo_id = $v;
            $this->modifiedColumns[] = CorreoPeer::CORREO_ID;
        }
    ...
    /**
     * Set the value of [correo_nombre] column.
     *
     * @param  string $v new value
     * @return Correo The current object (for fluent API support)
     */
    public function setCorreoNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->correo_nombre !== $v) {
            $this->correo_nombre = $v;
            $this->modifiedColumns[] = CorreoPeer::CORREO_NOMBRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->correo_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->correo_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = CorreoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CorreoPeer::CORREO_ID;
        if (null !== $this->correo_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CorreoPeer::CORREO_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CorreoPeer::CORREO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`correo_id`';
        }
        if ($this->isColumnModified(CorreoPeer::CORREO_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`correo_nombre`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`correo_id`':
                        ...
                        break;
                    case '`correo_nombre`':
                        $stmt->bindValue($identifier, $this->correo_nombre, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getCorreoId(),
            $keys[1] => $this->getCorreoNombre(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setCorreoId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setCorreoNombre($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CorreoPeer::CORREO_ID)) $criteria->add(CorreoPeer::CORREO_ID, $this->correo_id);
        if ($this->isColumnModified(CorreoPeer::CORREO_NOMBRE)) $criteria->add(CorreoPeer::CORREO_NOMBRE, $this->correo_nombre);
    ...
    {
        $criteria = new Criteria(CorreoPeer::DATABASE_NAME);
        $criteria->add(CorreoPeer::CORREO_ID, $this->correo_id);
    ...
    /**
     * Generic method to set the primary key (correo_id column).
     *
    ...
    {
        $copyObj->setCorreoNombre($this->getCorreoNombre());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCorreoId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     * If this Correo is new, it will return
    ...
    public function setVacantecorreos(PropelCollection $vacantecorreos, PropelPDO $con = null)
    {
        ...
        foreach ($vacantecorreosToDelete as $vacantecorreoRemoved) {
            $vacantecorreoRemoved->setCorreo(null);
        }
     ...
     * Otherwise if this Correo is new, it will return
     * an empty collection; or if this Correo has previously
     * been saved, it will retrieve related Vacantecorreos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Correo.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Vacantecorreo[] List of Vacantecorreo objects
     */
    public function getVacantecorreosJoinVacante($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = VacantecorreoQuery::create(null, $criteria);
