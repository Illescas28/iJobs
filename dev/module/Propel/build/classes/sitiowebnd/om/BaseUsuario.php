...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[] = UsuarioPeer::USUARIO_ID;
        }
    ...
    public function setUsuarioContrasena($v)
    {
        ...
        if ($this->usuario_contrasena !== $v) {
            ...
            $this->modifiedColumns[] = UsuarioPeer::USUARIO_CONTRASENA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->usuario_contrasena = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::USUARIO_ID)) {
        ...
        if ($this->isColumnModified(UsuarioPeer::USUARIO_CONTRASENA)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getUsuarioContrasena(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setUsuarioContrasena($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::USUARIO_ID)) $criteria->add(UsuarioPeer::USUARIO_ID, $this->usuario_id);
        if ($this->isColumnModified(UsuarioPeer::USUARIO_NOMBRE)) $criteria->add(UsuarioPeer::USUARIO_NOMBRE, $this->usuario_nombre);
        if ($this->isColumnModified(UsuarioPeer::USUARIO_CONTRASENA)) $criteria->add(UsuarioPeer::USUARIO_CONTRASENA, $this->usuario_contrasena);
    ...
    {
        $criteria = new Criteria(UsuarioPeer::DATABASE_NAME);
        $criteria->add(UsuarioPeer::USUARIO_ID, $this->usuario_id);
