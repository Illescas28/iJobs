...
/**
 * Base class that represents a row from the 'postulante' table.
 *
 *
 *
 * @package    propel.generator.sitiowebnd.om
 */
abstract class BasePostulante extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PostulantePeer';
    ...
    /**
     * The value for the postulante_curriculum_vitae field.
     * @var        string
     */
    protected $postulante_curriculum_vitae;
    ...
    /**
     * Get the [postulante_curriculum_vitae] column value.
     *
     * @return string
     */
    public function getPostulanteCurriculumVitae()
    {

        return $this->postulante_curriculum_vitae;
    }
     ...
     * @return Postulante The current object (for fluent API support)
     */
    public function setPostulanteId($v)
    {
        ...
        if ($this->postulante_id !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_ID;
        }
    ...
    public function setVacanteId($v)
    {
        ...
        if ($this->vacante_id !== $v) {
            $this->vacante_id = $v;
            $this->modifiedColumns[] = PostulantePeer::VACANTE_ID;
        }
    ...
    public function setArealaboralId($v)
    {
        ...
        if ($this->arealaboral_id !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::AREALABORAL_ID;
        }

        if ($this->aArealaboral !== null && $this->aArealaboral->getArealaboralId() !== $v) {
            $this->aArealaboral = null;
        }
    ...
    public function setEducacionId($v)
    {
        ...
        if ($this->educacion_id !== $v) {
            $this->educacion_id = $v;
            $this->modifiedColumns[] = PostulantePeer::EDUCACION_ID;
        }
    ...
    public function setPostulanteCorreo($v)
    {
        ...
        if ($this->postulante_correo !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_CORREO;
        }
    ...
    public function setPostulanteNombreCompleto($v)
    {
        ...
        if ($this->postulante_nombre_completo !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_NOMBRE_COMPLETO;
        }
    ...
    public function setPostulanteTelefono($v)
    {
        ...
        if ($this->postulante_telefono !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_TELEFONO;
        }
    ...
    public function setPostulanteEnlace($v)
    {
        ...
        if ($this->postulante_enlace !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_ENLACE;
        }
    ...
    public function setPostulanteMensaje($v)
    {
        ...
        if ($this->postulante_mensaje !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_MENSAJE;
        }
    ...
    /**
     * Set the value of [postulante_curriculum_vitae] column.
     *
     * @param  string $v new value
     * @return Postulante The current object (for fluent API support)
     */
    public function setPostulanteCurriculumVitae($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->postulante_curriculum_vitae !== $v) {
            $this->postulante_curriculum_vitae = $v;
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_CURRICULUM_VITAE;
        }


        return $this;
    } // setPostulanteCurriculumVitae()
    ...
    public function setPostulanteEducacionEstatus($v)
    {
        ...
        if ($this->postulante_educacion_estatus !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_EDUCACION_ESTATUS;
        }
    ...
    /**
     * Set the value of [postulante_educacion_certificado] column.
     *
     * @param  string $v new value
     * @return Postulante The current object (for fluent API support)
     */
    public function setPostulanteEducacionCertificado($v)
    {
        ...
        if ($this->postulante_educacion_certificado !== $v) {
            ...
            $this->modifiedColumns[] = PostulantePeer::POSTULANTE_EDUCACION_CERTIFICADO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->postulante_curriculum_vitae = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->postulante_educacion_estatus = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->postulante_educacion_certificado = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->resetModified();
            ...
            return $startcol + 12; // 12 = PostulantePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Postulante object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aArealaboral !== null && $this->arealaboral_id !== $this->aArealaboral->getArealaboralId()) {
            $this->aArealaboral = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PostulantePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PostulanteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PostulantePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aArealaboral !== null) {
                if ($this->aArealaboral->isModified() || $this->aArealaboral->isNew()) {
                    $affectedRows += $this->aArealaboral->save($con);
                }
                $this->setArealaboral($this->aArealaboral);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_id`';
        }
        if ($this->isColumnModified(PostulantePeer::VACANTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`vacante_id`';
        }
        if ($this->isColumnModified(PostulantePeer::AREALABORAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`arealaboral_id`';
        }
        if ($this->isColumnModified(PostulantePeer::EDUCACION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`educacion_id`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_CORREO)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_correo`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_NOMBRE_COMPLETO)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_nombre_completo`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_TELEFONO)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_telefono`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_ENLACE)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_enlace`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_MENSAJE)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_mensaje`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_CURRICULUM_VITAE)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_curriculum_vitae`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_EDUCACION_ESTATUS)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_educacion_estatus`';
        }
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_EDUCACION_CERTIFICADO)) {
            $modifiedColumns[':p' . $index++]  = '`postulante_educacion_certificado`';
        }

        $sql = sprintf(
            'INSERT INTO `postulante` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`postulante_mensaje`':
                        ...
                        break;
                    case '`postulante_curriculum_vitae`':
                        $stmt->bindValue($identifier, $this->postulante_curriculum_vitae, PDO::PARAM_STR);
                        break;
                    ...
                    case '`postulante_educacion_certificado`':
                        $stmt->bindValue($identifier, $this->postulante_educacion_certificado, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aArealaboral !== null) {
                if (!$this->aArealaboral->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aArealaboral->getValidationFailures());
                }
            }
            ...
            if (($retval = PostulantePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PostulantePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 8:
                ...
                break;
            case 9:
                return $this->getPostulanteCurriculumVitae();
                break;
            case 10:
    ...
    {
        if (isset($alreadyDumpedObjects['Postulante'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Postulante'][$this->getPrimaryKey()] = true;
        $keys = PostulantePeer::getFieldNames($keyType);
        $result = array(
            ...
            $keys[9] => $this->getPostulanteCurriculumVitae(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aArealaboral) {
                $result['Arealaboral'] = $this->aArealaboral->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 8:
                ...
                break;
            case 9:
                $this->setPostulanteCurriculumVitae($value);
                break;
            case 10:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) $this->setPostulanteCurriculumVitae($arr[$keys[9]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_ID)) $criteria->add(PostulantePeer::POSTULANTE_ID, $this->postulante_id);
        if ($this->isColumnModified(PostulantePeer::VACANTE_ID)) $criteria->add(PostulantePeer::VACANTE_ID, $this->vacante_id);
        if ($this->isColumnModified(PostulantePeer::AREALABORAL_ID)) $criteria->add(PostulantePeer::AREALABORAL_ID, $this->arealaboral_id);
        if ($this->isColumnModified(PostulantePeer::EDUCACION_ID)) $criteria->add(PostulantePeer::EDUCACION_ID, $this->educacion_id);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_CORREO)) $criteria->add(PostulantePeer::POSTULANTE_CORREO, $this->postulante_correo);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_NOMBRE_COMPLETO)) $criteria->add(PostulantePeer::POSTULANTE_NOMBRE_COMPLETO, $this->postulante_nombre_completo);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_TELEFONO)) $criteria->add(PostulantePeer::POSTULANTE_TELEFONO, $this->postulante_telefono);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_ENLACE)) $criteria->add(PostulantePeer::POSTULANTE_ENLACE, $this->postulante_enlace);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_MENSAJE)) $criteria->add(PostulantePeer::POSTULANTE_MENSAJE, $this->postulante_mensaje);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_CURRICULUM_VITAE)) $criteria->add(PostulantePeer::POSTULANTE_CURRICULUM_VITAE, $this->postulante_curriculum_vitae);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_EDUCACION_ESTATUS)) $criteria->add(PostulantePeer::POSTULANTE_EDUCACION_ESTATUS, $this->postulante_educacion_estatus);
        if ($this->isColumnModified(PostulantePeer::POSTULANTE_EDUCACION_CERTIFICADO)) $criteria->add(PostulantePeer::POSTULANTE_EDUCACION_CERTIFICADO, $this->postulante_educacion_certificado);
    ...
    {
        $criteria = new Criteria(PostulantePeer::DATABASE_NAME);
        $criteria->add(PostulantePeer::POSTULANTE_ID, $this->postulante_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Postulante (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPostulanteCurriculumVitae($this->getPostulanteCurriculumVitae());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Postulante Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PostulantePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PostulantePeer();
        }
    ...
    /**
     * Declares an association between this object and a Arealaboral object.
     *
     * @param                  Arealaboral $v
     * @return Postulante The current object (for fluent API support)
     * @throws PropelException
     */
    public function setArealaboral(Arealaboral $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the Arealaboral object, it will not be re-added.
        if ($v !== null) {
            $v->addPostulante($this);
        }
    ...
    /**
     * Get the associated Arealaboral object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Arealaboral The associated Arealaboral object.
     * @throws PropelException
     */
    public function getArealaboral(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aArealaboral === null && ($this->arealaboral_id !== null) && $doQuery) {
            $this->aArealaboral = ArealaboralQuery::create()->findPk($this->arealaboral_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArealaboral->addPostulantes($this);
             */
        }

        return $this->aArealaboral;
    }
    ...
    public function getEducacion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEducacion === null && ($this->educacion_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEducacion->addPostulantes($this);
             */
        }
    ...
    public function getVacante(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aVacante === null && ($this->vacante_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVacante->addPostulantes($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->postulante_curriculum_vitae = null;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aArealaboral instanceof Persistent) {
              $this->aArealaboral->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(PostulantePeer::DEFAULT_STRING_FORMAT);
    }
