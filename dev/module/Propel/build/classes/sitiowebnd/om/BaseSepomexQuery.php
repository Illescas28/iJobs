 ...
 *
 * @method SepomexQuery leftJoinSucursal($relationAlias = null) Adds a LEFT JOIN clause to the query using the Sucursal relation
 * @method SepomexQuery rightJoinSucursal($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Sucursal relation
 * @method SepomexQuery innerJoinSucursal($relationAlias = null) Adds a INNER JOIN clause to the query using the Sucursal relation
 *
...
abstract class BaseSepomexQuery extends ModelCriteria
{
    ...
    public function filterBySucursal($sucursal, $comparison = null)
    {
        if ($sucursal instanceof Sucursal) {
            return $this
                ->addUsingAlias(SepomexPeer::SEPOMEX_ID, $sucursal->getSepomexId(), $comparison);
