...
abstract class BaseEmpresaPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('EmpresaId', 'EmpresaNombre', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('empresaId', 'empresaNombre', ),
        BasePeer::TYPE_COLNAME => array (EmpresaPeer::EMPRESA_ID, EmpresaPeer::EMPRESA_NOMBRE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('EMPRESA_ID', 'EMPRESA_NOMBRE', ),
        BasePeer::TYPE_FIELDNAME => array ('empresa_id', 'empresa_nombre', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('EmpresaId' => 0, 'EmpresaNombre' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('empresaId' => 0, 'empresaNombre' => 1, ),
        BasePeer::TYPE_COLNAME => array (EmpresaPeer::EMPRESA_ID => 0, EmpresaPeer::EMPRESA_NOMBRE => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('EMPRESA_ID' => 0, 'EMPRESA_NOMBRE' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('empresa_id' => 0, 'empresa_nombre' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EmpresaPeer::EMPRESA_ID);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(EmpresaPeer::EMPRESA_ID) && $criteria->keyContainsValue(EmpresaPeer::EMPRESA_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.EmpresaPeer::EMPRESA_ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(EmpresaPeer::EMPRESA_ID);
            $value = $criteria->remove(EmpresaPeer::EMPRESA_ID);
            if ($value) {
                $selectCriteria->add(EmpresaPeer::EMPRESA_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(EmpresaPeer::EMPRESA_ID, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(SucursalPeer::EMPRESA_ID, $obj->getEmpresaId());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(EmpresaPeer::DATABASE_NAME);
        $criteria->add(EmpresaPeer::EMPRESA_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(EmpresaPeer::DATABASE_NAME);
            $criteria->add(EmpresaPeer::EMPRESA_ID, $pks, Criteria::IN);
