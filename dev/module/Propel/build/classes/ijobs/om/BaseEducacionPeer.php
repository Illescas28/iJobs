...
abstract class BaseEducacionPeer
{
    ...
    /** the column name for the educacion_descripcion field */
    const EDUCACION_DESCRIPCION = 'educacion.educacion_descripcion';

    /** the column name for the educacion_fecha_alta field */
    const EDUCACION_FECHA_ALTA = 'educacion.educacion_fecha_alta';

    /** the column name for the educacion_usuario_alta field */
    const EDUCACION_USUARIO_ALTA = 'educacion.educacion_usuario_alta';

    /** the column name for the educacion_fecha_modifica field */
    const EDUCACION_FECHA_MODIFICA = 'educacion.educacion_fecha_modifica';

    /** the column name for the educacion_usuario_modifica field */
    const EDUCACION_USUARIO_MODIFICA = 'educacion.educacion_usuario_modifica';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('EducacionId', 'EducacionNombre', 'EducacionDescripcion', 'EducacionFechaAlta', 'EducacionUsuarioAlta', 'EducacionFechaModifica', 'EducacionUsuarioModifica', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('educacionId', 'educacionNombre', 'educacionDescripcion', 'educacionFechaAlta', 'educacionUsuarioAlta', 'educacionFechaModifica', 'educacionUsuarioModifica', ),
        BasePeer::TYPE_COLNAME => array (EducacionPeer::EDUCACION_ID, EducacionPeer::EDUCACION_NOMBRE, EducacionPeer::EDUCACION_DESCRIPCION, EducacionPeer::EDUCACION_FECHA_ALTA, EducacionPeer::EDUCACION_USUARIO_ALTA, EducacionPeer::EDUCACION_FECHA_MODIFICA, EducacionPeer::EDUCACION_USUARIO_MODIFICA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('EDUCACION_ID', 'EDUCACION_NOMBRE', 'EDUCACION_DESCRIPCION', 'EDUCACION_FECHA_ALTA', 'EDUCACION_USUARIO_ALTA', 'EDUCACION_FECHA_MODIFICA', 'EDUCACION_USUARIO_MODIFICA', ),
        BasePeer::TYPE_FIELDNAME => array ('educacion_id', 'educacion_nombre', 'educacion_descripcion', 'educacion_fecha_alta', 'educacion_usuario_alta', 'educacion_fecha_modifica', 'educacion_usuario_modifica', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('EducacionId' => 0, 'EducacionNombre' => 1, 'EducacionDescripcion' => 2, 'EducacionFechaAlta' => 3, 'EducacionUsuarioAlta' => 4, 'EducacionFechaModifica' => 5, 'EducacionUsuarioModifica' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('educacionId' => 0, 'educacionNombre' => 1, 'educacionDescripcion' => 2, 'educacionFechaAlta' => 3, 'educacionUsuarioAlta' => 4, 'educacionFechaModifica' => 5, 'educacionUsuarioModifica' => 6, ),
        BasePeer::TYPE_COLNAME => array (EducacionPeer::EDUCACION_ID => 0, EducacionPeer::EDUCACION_NOMBRE => 1, EducacionPeer::EDUCACION_DESCRIPCION => 2, EducacionPeer::EDUCACION_FECHA_ALTA => 3, EducacionPeer::EDUCACION_USUARIO_ALTA => 4, EducacionPeer::EDUCACION_FECHA_MODIFICA => 5, EducacionPeer::EDUCACION_USUARIO_MODIFICA => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('EDUCACION_ID' => 0, 'EDUCACION_NOMBRE' => 1, 'EDUCACION_DESCRIPCION' => 2, 'EDUCACION_FECHA_ALTA' => 3, 'EDUCACION_USUARIO_ALTA' => 4, 'EDUCACION_FECHA_MODIFICA' => 5, 'EDUCACION_USUARIO_MODIFICA' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('educacion_id' => 0, 'educacion_nombre' => 1, 'educacion_descripcion' => 2, 'educacion_fecha_alta' => 3, 'educacion_usuario_alta' => 4, 'educacion_fecha_modifica' => 5, 'educacion_usuario_modifica' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EducacionPeer::EDUCACION_DESCRIPCION);
            $criteria->addSelectColumn(EducacionPeer::EDUCACION_FECHA_ALTA);
            $criteria->addSelectColumn(EducacionPeer::EDUCACION_USUARIO_ALTA);
            $criteria->addSelectColumn(EducacionPeer::EDUCACION_FECHA_MODIFICA);
            $criteria->addSelectColumn(EducacionPeer::EDUCACION_USUARIO_MODIFICA);
        } else {
            $criteria->addSelectColumn($alias . '.educacion_id');
            $criteria->addSelectColumn($alias . '.educacion_nombre');
            $criteria->addSelectColumn($alias . '.educacion_descripcion');
            $criteria->addSelectColumn($alias . '.educacion_fecha_alta');
            $criteria->addSelectColumn($alias . '.educacion_usuario_alta');
            $criteria->addSelectColumn($alias . '.educacion_fecha_modifica');
            $criteria->addSelectColumn($alias . '.educacion_usuario_modifica');
        }
    }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(PostulantesPeer::EDUCACION_ID, $obj->getEducacionId());
